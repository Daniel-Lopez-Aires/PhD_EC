...
def Pipetting_tester(pipette_volume, mass_measurements, delta_m = .00001, bins = 15):
    ...
    *Outputs:
    ...
    #This guys computes the systematic and random error. 
        #Systematic error is a measure of the deviation of the mean volume from 
            #the target volume
        #Random error is a measure of the dispersion of the individual values around
            #the mean value 
        
        #[Eppeddorf Manual, 92 pages, page 52]
